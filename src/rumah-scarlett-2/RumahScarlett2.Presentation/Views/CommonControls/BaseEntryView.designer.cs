namespace RumahScarlett2.Presentation.Views.CommonControls
{
   partial class BaseEntryView
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.panelUp = new RumahScarlett2.Presentation.Views.CommonControls.PanelUp();
         this.operationButtons = new RumahScarlett2.Presentation.Views.CommonControls.OperationButtons();
         this.SuspendLayout();
         // 
         // panelUp
         // 
